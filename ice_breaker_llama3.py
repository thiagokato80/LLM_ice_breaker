...
#def ice_breaker_with(name: str) -> str:
    ...
    #linkedin_data = scrapeLinkedIn(name=linkedin_username)
    linkedin_data = scrapeLinkedIn(name=name)
    ...
    llm = AI21LLM(model="j2-ultra", temperature=0, max_tokens=500)
